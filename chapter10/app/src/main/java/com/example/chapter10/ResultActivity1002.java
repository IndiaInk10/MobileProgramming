...
public class ResultActivity1002 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {

        super.onCreate(savedInstanceState);
        setContentView(R.layout.result_1002_org);
        setTitle("투표 결과");
        ...
        if(v.size() == 1)  tvTop.setText("최대 투표 1명 : " + imageName[maxEntry]);
        else  tvTop.setText("최대 투표 " + v.size() + "명: " + v);

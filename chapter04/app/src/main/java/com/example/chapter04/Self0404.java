...
public class Self0404 extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.self0404_main);
        ...
        final int draw[] = { R.drawable.pie,
                R.drawable.q10, R.drawable.r11};
        ...
        for (int i = 0; i < radioArray.length; i++) {
            ...
            radioArray[index].setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    imgPet.setVisibility(View.VISIBLE); imgPet.setImageResource(draw[index]);
                }
            });
        }

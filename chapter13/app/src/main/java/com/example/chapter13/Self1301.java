...
public class Self1301 extends AppCompatActivity {

    ListView listViewMP3;
    Button btnPlay, btnPause, btnStop;
    TextView tvProcess, tvMP3;
    ProgressBar pbMP3;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.self1301_main);

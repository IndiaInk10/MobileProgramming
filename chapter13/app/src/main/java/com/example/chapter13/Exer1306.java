...
public class Exer1306 extends AppCompatActivity  {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.exer1306_main_org);
        setTitle("연습문제 13-6");
        ...
        btnPlay.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                btnPause.setBackgroundColor(Color.parseColor("#FF6200EE"));
                btnStop.setBackgroundColor(Color.parseColor("#FF6200EE"));
        ...
        btnPause.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                btnPlay.setBackgroundColor(Color.parseColor("#FF6200EE"));
